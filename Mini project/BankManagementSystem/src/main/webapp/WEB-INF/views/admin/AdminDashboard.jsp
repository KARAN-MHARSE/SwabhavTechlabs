	...
	<div class="flex flex-1 h-full">
		...
		<aside class="bg-gray-100 w-64 p-6 space-y-4 border-r">
			<a href=<%=request.getContextPath() + "/AdminDashboardController"%>
				...
				class="block px-4 py-2 rounded hover:bg-blue-200">Transactions</a> <a
				href=<%=request.getContextPath() + "/AdminDashboardController?action=updateuserprofile"%>
				class="block px-4 py-2 rounded hover:bg-blue-200">Update User profile</a>
		</aside>
		...
		<main class="flex-1 p-6 bg-gray-50">
			<c:choose>
				...
				<c:when test="${action eq 'updateuserprofile' }">
					<jsp:include page="/WEB-INF/views/admin/pages/UpdateUserProfile.jsp" />
